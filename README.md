...
This repository holds the code to create a relational database to house data on Alaska salmon from 1922 - 2017. The Alaska salmon data is publicly available and is located in the [The Knowledge Network for Biocomplexity (KNB) datasets](https://knb.ecoinformatics.org/view/doi:10.5063/F1707ZTM). This dataset has over 14 million entries hence it is not included directly in this repository.
